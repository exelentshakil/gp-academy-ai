...
const telemetryStream = [
  { time: '09:00', ops: 3820, latency: 14.8, stage: 'Rider Video Intake & Stance Detection' },
  { time: '10:00', ops: 4790, latency: 14.1, stage: 'Foil Mast Pitch & Roll Angle Audit' },
  { time: '11:00', ops: 4210, latency: 13.9, stage: 'Wing Angle of Attack & Trim Synth' },
  { time: '12:00', ops: 5680, latency: 14.4, stage: 'Wind Knots & Choppy Water Normalizer' },
  { time: '13:00', ops: 5120, latency: 13.8, stage: 'Personalized Coaching Drill Engine' },
  { time: '14:00', ops: 6450, latency: 13.2, stage: 'Stripe Subscription Access Check' },
  { time: '15:00', ops: 5890, latency: 13.5, stage: 'GP Masterclass Chapter Recommendation' },
  { time: '16:00', ops: 6820, latency: 12.8, stage: 'Athlete Mobile Telemetry HUD' },
  { time: '17:00', ops: 6180, latency: 13.4, stage: 'Flight Stability Score Verifier' },
  { time: '18:00', ops: 6450, latency: 13.2, stage: 'Pro Coach Signoff & Action Plan' },
];
          ...
          <div>
            <div className="flex items-center gap-2">
              ...
              <span className="text-sm sm:text-[15px] font-bold tracking-tight text-[var(--color-text-primary)]">
                AI Flight Biomechanics & Coaching Bus • Sub-90ms Telemetry
              </span>
