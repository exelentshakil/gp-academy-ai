        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center">
          ...
          <div className="lg:col-span-7 space-y-6">
            ...
            <div className="inline-flex items-center gap-2 rounded-full border border-[var(--color-border)] bg-[var(--color-surface)]/95 px-3.5 py-1.5 text-xs sm:text-[13.5px] text-[var(--color-text-secondary)] shadow-2xs backdrop-blur-sm">
              ...
              <span className="font-bold text-[var(--color-text-primary)]">GP Academy Engine:</span>
              <span>Real-Time Flight & Biomechanics Active</span>
            ...
            <div className="pt-8 border-t border-[var(--color-border)]/80 max-w-2xl">
              <p className="text-xs font-semibold uppercase tracking-wider text-[var(--color-text-secondary)] mb-3">
                Validated across international wingfoil & water-sports coaching circuits
              </p>
              <div className="flex flex-wrap items-center justify-between gap-5 opacity-90 grayscale hover:grayscale-0 transition-all">
                <span className="text-[15px] sm:text-base font-bold tracking-tight text-[var(--color-text-primary)] font-sans">Duotone</span>
                <span className="text-[15px] sm:text-base font-bold tracking-tight text-[var(--color-text-primary)] font-sans">Sabfoil</span>
                <span className="text-[15px] sm:text-base font-semibold tracking-tight text-[var(--color-text-primary)] font-sans">F-One</span>
                <span className="text-[15px] sm:text-base font-bold tracking-tight text-[var(--color-text-primary)] font-sans">Stripe</span>
                <span className="text-[15px] sm:text-base font-semibold tracking-tight text-[var(--color-text-primary)] font-sans">Lake Garda</span>
                <span className="text-[15px] sm:text-base font-bold tracking-tight text-[var(--color-text-primary)] font-sans">Tarifa Pro</span>
                <span className="text-[15px] sm:text-base font-medium tracking-tight text-[var(--color-text-primary)] font-sans">Armstrong</span>
              </div>
            </div>
          </div>
            ...
            <div className="w-full max-w-md rounded-xl border border-[var(--color-border)] bg-[var(--color-surface)]/85 backdrop-blur-xl p-5 sm:p-6 shadow-xl space-y-4 relative">
                ...
                <div className="rounded-lg bg-[#0A0D14] text-slate-200 p-3.5 space-y-2.5 border border-slate-800">
                  <div className="flex items-center justify-between text-xs text-slate-300 pb-1.5 border-b border-slate-800">
                    <span className="flex items-center gap-2 font-medium">
                      ...
                      4K Video Masterclass HLS Stream
                    </span>
              ...
              <div className="flex items-center justify-between text-xs text-[var(--color-text-secondary)] pt-1 font-medium">
                <span className="flex items-center gap-1.5">
                  ...
                  AI Biomechanics Engine Active
                </span>
                <span className="text-[var(--color-text-muted)]">OpenAI + Gemini Failover</span>
              </div>
            </div>
          </div>
